...
class BListView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.cl_blistview)) { v, insets ->
        ...
        adaptador.notifyDataSetChanged() //Actualizar el UI
    ...
    fun mostrarSnackbar(texto:String){
        val snack = Snackbar.make(
            findViewById(R.id.cl_blistview),
            texto,
